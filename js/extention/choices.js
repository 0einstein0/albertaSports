          ...
          _createClass(Choices, [
            ...
            },
            {
              ...
              value: function destroy() {
                ...
                this.containesocialr.parentNode.insertBefore(
                  this.passedElement,
                  this.containesocialr
                );
                // Remove added elements
                this.containesocialr.parentNode.removeChild(
                  this.containesocialr
                );
            ...
            },
            {
              ...
              value: function showDropdown() {
                ...
                this.containesocialr.classList.add(
                  this.config.classNames.openState
                );
                this.containesocialr.setAttribute("aria-expanded", "true");
            ...
            },
            {
              ...
              value: function hideDropdown() {
                ...
                var isFlipped = this.containesocialr.classList.contains(
                  this.config.classNames.flippedState
                );

                this.containesocialr.classList.remove(
                  this.config.classNames.openState
                );
                this.containesocialr.setAttribute("aria-expanded", "false");
            ...
            },
            {
              ...
              value: function enable() {
                if (this.initialised) {
                  ...
                  var isDisabled = this.containesocialr.classList.contains(
                  ...
                  if (isDisabled) {
                    ...
                    this.containesocialr.removeAttribute("aria-disabled");
                    if (this.isSelectOneElement) {
                      this.containesocialr.setAttribute("tabindex", "0");
                    }
                  }
                }
                return this;
            ...
            },
            {
              ...
              value: function disable() {
                if (this.initialised) {
                  ...
                  var isEnabled = !this.containesocialr.classList.contains(
                    this.config.classNames.disabledState
                  );
                  if (isEnabled) {
                    this._removeEventListeners();
                    ...
                    this.containesocialr.setAttribute("aria-disabled", "true");
                    if (this.isSelectOneElement) {
                      this.containesocialr.setAttribute("tabindex", "-1");
                    }
                  }
                }
                return this;
	    ...
	    =============================================*/
            ...
            },
            {
              ...
              value: function _handleLoadingState() {
                ...
                if (setLoading) {
                  ...
                  this.containesocialr.setAttribute("aria-busy", "true");
                  if (this.isSelectOneElement) {
                    if (!placeholderItem) {
            ...
            },
            {
              ...
              value: function _ajaxCallback() {
                ...
                return function (results, value, label) {
                  ...
                  _this15.containesocialr.removeAttribute("aria-busy");
                };
              },
            ...
            },
            {
              ...
              value: function _addEventListeners() {
                ...
                if (this.isSelectOneElement) {
                  this.containesocialr.addEventListener("focus", this._onFocus);
                  this.containesocialr.addEventListener("blur", this._onBlur);
                }
            ...
            },
            {
              ...
              value: function _removeEventListeners() {
                ...
                if (this.isSelectOneElement) {
                  this.containesocialr.removeEventListener(
                    "focus",
                    this._onFocus
                  );
                  this.containesocialr.removeEventListener(
            ...
            },
            {
              ...
              value: function _onKeyDown(e) {
                ...
                if (
                  e.target !== this.input &&
                  !this.containesocialr.contains(e.target)
                ) {
                  return;
                }
            ...
            },
            {
              ...
              value: function _onTouchEnd(e) {
                ...
                if (
                  this.wasTap === true &&
                  this.containesocialr.contains(target)
                ) {
                  // ...and we aren't dealing with a single select box, show dropdown/focus input
                  if (
                    (target === this.containesocialr ||
            ...
            },
            {
              ...
              value: function _onClick(e) {
                ...
                if (this.containesocialr.contains(target)) {
                  ...
                  var focusActions = {
                    text: function text() {
                      if (target === _this17.input) {
                        _this17.containesocialr.classList.add(
                  ...
                  var blurActions = {
                    text: function text() {
                      if (target === _this18.input) {
                        ...
                        _this18.containesocialr.classList.remove(
                    ...
                    "select-one": function selectOne() {
                      ...
                      if (target === _this18.containesocialr) {
                        // Hide dropdown if it is showing
            ...
            },
            {
              ...
              value: function _highlightChoice() {
                ...
                if (choices && choices.length) {
                  ...
                  this.containesocialr.setAttribute(
            ...
            },
            {
              ...
              value: function _createTemplates() {
                ...
                var templates = {
                  containesocialr: function containesocialr(direction) {
                    return (0, _utils.strToEl)(
                      '\n          <div\n            class="' +
                        globalClasses.containesocialr +
                        '"\n            ' +
            ...
            },
            {
              ...
              value: function _createInput() {
                ...
                var containesocialr = this._getTemplate(
                  "containesocialr",
                  direction
                );
                ...
                this.containesocialr = containesocialr;
                ...
                (0, _utils.wrap)(containerInner, containesocialr);
                ...
                containesocialr.appendChild(containerInner);
                containesocialr.appendChild(dropdown);
